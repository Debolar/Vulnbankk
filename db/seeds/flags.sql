...
VALUES
    ...
    (11,  'A19', 'PWR{S0urc3_M4ps_L34k}',        'Aplikacja błędnie udostępnia pliki Source Maps na produkcji',   'easy',   100),
    ...
    (15, 'A14', 'PWR{m4ss_4ss1gnm3nt_pr1v_3sc}', 'Mass Assignment - eskalacja uprawnień', 'medium', 150),
    ...
    (19, 'A18', 'PWR{t1mpl4t3_inj3ct10n}', 'Server-Side Template Injection - złe renderowanie Jinja2', 'hard', 200),
    (20, 'A20', 'PWR{race_condition_double_spend}', 'Race condition double spend - check-then-act without synchronization', 'hard', 200);
